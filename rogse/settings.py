"""
Django settings for rogse project.
...
SECRET_KEY = 'd6a7=zii7&!flb-qq9+!+)@i$dek(wb0g%21g9kz=8o33l^dj!'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'douban.context_processors.douban_obj',
            ],
        },
    },
]

WSGI_APPLICATION = 'rogse.wsgi.application'
